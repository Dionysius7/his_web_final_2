...
class RequestConditionResponsePage extends StatelessWidget {
  const RequestConditionResponsePage({required this.responseStatus});
                        ...
                        child: responseStatus == "success"
                            ? Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Please inform your patient to check notification",
                                    style: TextStyle(
                                      color: Colors.grey,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 16,
