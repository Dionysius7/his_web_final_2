...
import 'package:his_web_final/views/request_condition_response_page.dart';
import 'package:his_web_final/widgets/bottom_bar.dart';
import 'package:get/get.dart';
import 'package:flutter_easyloading/flutter_easyloading.dart';

class RequestConditionPage extends StatelessWidget {
                                    ...
                                    onPressed: () async {
                                      if (_formKey.currentState!.validate()) {
                                        ...
                                        if (resultMessage == "200") {
                                          EasyLoading.dismiss();
                                          Get.off(RequestConditionResponsePage(
