...
List<ConditionModel> conditionModelFromJson(String str) =>
    List<ConditionModel>.from(
        json.decode(str).map((x) => ConditionModel.fromJson(x)));

String conditionModelToJson(List<ConditionModel> data) =>
